...
def get_openai_client() -> openai.AsyncOpenAI:
    ...
    if not api_key:
        raise HTTPException(status_code=500, detail="OpenAI API Key no configurada o inválida.")
...
async def transcribe_audio(file_bytes: bytes, filename: str) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error en el motor de transcripción.")
