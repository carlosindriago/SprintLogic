...
def _extract_keywords(query: str) -> list[str]:
    ...
    skip = {"el", "la", "los", "las", "un", "una", "de", "del", "en", "que",
            "es", "no", "si", "por", "para", "con", "como", "me", "se", "lo",
            "the", "a", "an", "is", "in", "of", "to", "it", "and", "or",
            "hazme", "puedes", "podrías", "explicar", "cómo", "qué", "este",
            "this", "that", "explain", "what", "how", "can", "you"}
