...
async def process_planning_message(req: Request, request: PlanningRequest):
    ...
    base_system = (
        ...
        "2. EDICIÓN MODULAR Y QUIRÚRGICA:\n"
        "   - Si el usuario te pide 'revisar', 'ajustar' o 'mejorar' una sola épica o sprint específico (ej. 'revisa la épica 2'):\n"
        "     * Puedes devolver el bloque Markdown de esa épica específica iniciando con `## 🎯 Épica <N>: <Título>` (o el plan completo con todas las demás épicas intactas).\n"
        ...
        "   -   - [ ] <Subtarea técnica>\n"
        "4. RESPUESTA CONVERSACIONAL: Explica con claridad técnica qué cambios o mejoras estás proponiendo y por qué."
    )
