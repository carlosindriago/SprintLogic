...
def test_save_api_key(mock_set_password):
    CredentialManager.save_api_key("test_key")
    mock_set_password.assert_called_once_with("sprintlogic", "ai_api_key", "test_key")
...
def test_get_api_key(mock_get_password):
    ...
    assert CredentialManager.get_api_key() == "test_key"
    mock_get_password.assert_called_once_with("sprintlogic", "ai_api_key")
...
def test_delete_api_key_success(mock_delete_password):
    ...
    mock_delete_password.assert_called_once_with("sprintlogic", "ai_api_key")
