        ...
        return [
            {
                ...
                "source_file_path": "frontend/app.ts",
                "source_id": "file:frontend/app.ts",
            },
            {
                "depth": 1,
                "edge_type": EdgeType.IMPORTS,
                "source_file_path": "backend/controller.py",
                "source_id": "file:backend/controller.py",
            },
            {
                "depth": 2,
                "edge_type": EdgeType.IMPORTS,
                "source_file_path": "backend/router.py",
                "source_id": "file:backend/router.py",
            },
        ]
