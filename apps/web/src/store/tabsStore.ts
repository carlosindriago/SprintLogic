...
export type TabType = 'dashboard' | 'editor' | 'git-graph' | 'diff' | 'insights' | 'kanban' | 'graph' | 'audit' | 'ai-report' | 'ai-history' | 'auto-fix' | 'settings' | 'planning-studio' | 'database-studio' | 'test-studio' | 'document-studio' | 'execution-room' | 'security-studio' | 'legal-studio';
