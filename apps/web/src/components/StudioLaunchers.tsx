  ...
  return (
    <div className="flex items-center gap-2 p-2 bg-[#0a0a0a] border-b border-zinc-800 shrink-0">
      <div className="flex items-center gap-1 bg-zinc-800/50 rounded-lg p-1 shrink-0">
        ...
        <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-400 hover:text-white hover:bg-zinc-700" onClick={() => launchTool('kanban', 'Sprint Center', 'kanban')} title="Sprint Center"><Layout className="w-4 h-4" /></Button>
