    ...
    <div className="flex flex-col h-full min-h-0 w-full bg-[#0a0a0c] text-zinc-100 overflow-hidden font-sans">
      <div className="h-14 border-b border-zinc-800/80 bg-[#121215] px-4 flex items-center justify-between gap-4 shrink-0 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={handleSmartHandoffToKanban} disabled={isExporting || parsedTickets.length === 0} className="bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium gap-1.5"><Kanban className="w-3.5 h-3.5" /> Exportar al Sprint Center</Button>
        </div>
      </div>
